...
def get_question():
    ...
    for row in rows:
        ...
        def parse_json_field(field_json):
            if not field_json:
                return None  # Use None for single text field, or [] for array field
            try:
...
## EDITING QUESTIONS
allowed_question_fields_for_edit = {"question_stem", "concept_tags", "difficulty_rating_manual", "question_type",
