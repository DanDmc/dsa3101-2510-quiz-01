...
function App() {
    ...
    useEffect(() => {
        ...
        const dynamicGroupStrings = courses
            .filter(opt => opt.key !== 'All' && opt.key !== COURSE_UNKNOWN_KEY)
        ...
        console.log("Updated Course Groups (from consolidated useEffect):", dynamicGroupStrings);
    ...
    const handleDeleteGroup = async (groupName) => {
        ...
        try {
            ...
            setIsProcessing(false);
        } // ⭐ CHANGE 4: Fixed typo here (removed stray 's')
    };
